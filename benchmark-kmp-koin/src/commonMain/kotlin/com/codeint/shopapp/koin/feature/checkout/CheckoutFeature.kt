...
class PaymentProcessor constructor(
    ...
    fun processPayment(amount: Double, method: String): PaymentResult {
        ...
        return PaymentResult(true, "txn_${com.codeint.shopapp.common.platform.currentTimeMillis()}", null)
    }
}

class ShippingCalculator constructor(private val getShippingList: GetShippingListUseCase) {
...
class OrderValidator constructor(private val authManager: AuthManager) {
