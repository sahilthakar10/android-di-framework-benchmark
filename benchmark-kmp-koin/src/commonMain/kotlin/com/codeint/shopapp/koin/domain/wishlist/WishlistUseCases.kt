...
class GetWishlistListUseCase constructor(
...
class GetWishlistDetailUseCase constructor(
    private val repository: WishlistRepository,
    private val analytics: AnalyticsTracker
) {
...
class CreateWishlistUseCase constructor(
    private val repository: WishlistRepository,
...
class UpdateWishlistUseCase constructor(
    private val repository: WishlistRepository,
    private val logger: AppLogger
) {
...
class DeleteWishlistUseCase constructor(
    private val repository: WishlistRepository,
    private val logger: AppLogger
) {
...
class SearchWishlistUseCase constructor(
    private val repository: WishlistRepository,
    private val analytics: AnalyticsTracker
) {
...
class ValidateWishlistUseCase constructor(private val logger: AppLogger) {
...
class RefreshWishlistCacheUseCase constructor(
    private val repository: WishlistRepository,
    private val logger: AppLogger
) {
    fun execute() {
...
class GetWishlistCountUseCase constructor(private val repository: WishlistRepository) {
    fun execute(): Int = repository.getAll().totalCount
}

class FilterWishlistUseCase constructor(private val repository: WishlistRepository) {
