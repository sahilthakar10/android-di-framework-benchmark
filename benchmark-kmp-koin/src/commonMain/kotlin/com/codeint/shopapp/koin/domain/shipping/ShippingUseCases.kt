...
class GetShippingListUseCase constructor(
...
class GetShippingDetailUseCase constructor(
    private val repository: ShippingRepository,
    private val analytics: AnalyticsTracker
) {
...
class CreateShippingUseCase constructor(
    private val repository: ShippingRepository,
...
class UpdateShippingUseCase constructor(
    private val repository: ShippingRepository,
    private val logger: AppLogger
) {
...
class DeleteShippingUseCase constructor(
    private val repository: ShippingRepository,
    private val logger: AppLogger
) {
...
class SearchShippingUseCase constructor(
    private val repository: ShippingRepository,
    private val analytics: AnalyticsTracker
) {
...
class ValidateShippingUseCase constructor(private val logger: AppLogger) {
...
class RefreshShippingCacheUseCase constructor(
    private val repository: ShippingRepository,
    private val logger: AppLogger
) {
    fun execute() {
...
class GetShippingCountUseCase constructor(private val repository: ShippingRepository) {
    fun execute(): Int = repository.getAll().totalCount
}

class FilterShippingUseCase constructor(private val repository: ShippingRepository) {
