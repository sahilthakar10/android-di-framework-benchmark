...
class ChatNotificationHandler constructor(
    private val notificationManager: com.codeint.shopapp.koin.core.notification.NotificationManager,
    private val analytics: AnalyticsTracker
) {
    fun handleNewMessage(from: String, preview: String) { notificationManager.scheduleLocal("New message from $from", preview, 0) }
}

class TypingIndicatorManager constructor(private val webSocketManager: WebSocketManager) {
