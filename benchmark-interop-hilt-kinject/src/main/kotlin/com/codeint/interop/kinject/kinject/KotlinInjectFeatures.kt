...
/**
 * kotlin-inject-anvil SIDE — Feature implementations.
 * Uses shared interfaces from :benchmark-interop-hilt-metro.
 *
 * Each Hilt dependency passed as @get:Provides constructor parameter = MANUAL BRIDGE.
 */

@Inject class KInjectProductRepository(
    private val httpClient: HttpClient, private val cacheManager: CacheManager, private val logger: Logger
) : ProductRepository {
...
@Inject class KInjectCartRepository(
    private val authManager: AuthManager, private val databaseManager: DatabaseManager, private val logger: Logger
) : CartRepository {
...
@Inject class KInjectOrderService(
    private val authManager: AuthManager, private val httpClient: HttpClient,
    private val analyticsTracker: AnalyticsTracker, private val logger: Logger
) : OrderService {
...
/**
 * BRIDGE: 6 @get:Provides parameters = 6 lines of manual wiring.
 */
@Component
