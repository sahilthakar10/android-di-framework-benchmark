package com.codeint.shopapp.hilt.data.address
...
internal class OfflineFirstAddressRepository @Inject constructor(
    ...
    override fun getById(id: String): AddressDomainModel? {
    ...
    override fun create(model: AddressDomainModel): AddressDomainModel {
    ...
    override fun update(id: String, model: AddressDomainModel): AddressDomainModel {
        val entity = mapper.toEntity(model)
