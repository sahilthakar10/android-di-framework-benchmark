...
import com.codeint.shopapp.hilt.core.network.WebSocketManager
...
class ChatNotificationHandler @Inject constructor(
    private val notificationManager: com.codeint.shopapp.hilt.core.notification.NotificationManager,
    private val analytics: AnalyticsTracker
) {
