...
class CartCalculator @Inject constructor(private val getPromotionDetail: GetPromotionDetailUseCase) {
...
class CartBadgeManager @Inject constructor(private val getCartCount: GetCartCountUseCase) {
