...
@Inject @SingleIn(AppScope::class) @ContributesBinding(AppScope::class) class OfflineFirstShippingRepository(
    private val remote: ShippingRemoteDataSource, private val local: ShippingLocalDataSource,
    private val mapper: ShippingMapper, private val logger: AppLogger
) : ShippingRepository {
