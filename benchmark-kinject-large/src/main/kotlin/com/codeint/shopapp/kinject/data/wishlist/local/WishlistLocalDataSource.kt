package com.codeint.shopapp.kinject.data.wishlist.local

import com.codeint.shopapp.kinject.core.storage.*
import com.codeint.shopapp.kinject.data.wishlist.*
import me.tatarka.inject.annotations.Inject

@Inject class WishlistLocalDataSource(private val db: DatabaseManager, private val cache: CacheManager) {
